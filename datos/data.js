export const moviesData = [
    {
      id: 1,
      title: "Robot salvaje",
      description:"El épico viaje de un robot -la unidad 7134 de Roz,'Roz', que naufraga en una isla deshabitada y debe aprender a adaptarse al duro entorno, entablando gradualmente relaciones con los animales de la isla y convirtiéndose en padre adoptivo de un pequeño ganso huérfano.",
    ...
    {
      id: 3,
      title: "Mamma Mia! Una y otra vez",
      description:
    ...
    },
    {
      ...
      description:
        "Como uno de los creadores de cómics independientes más exitosos, Mignola ha inspirado a generaciones de escritores y artistas. Este largometraje documental explora el legado del legendario creador de cómics detrás de Hellboy. La película profundiza en la carrera de Mignola, desde sus inicios en Marvel hasta su éxito con Hellboy, con comentarios de Neil Gaiman sobre el universo de Mignola y de Rebecca Sugar sobre la influencia de Mignola en Steven Universe.",
    ...
    {
      id: 9,
      title: "El fantasma de la ópera de Andrew Lloyd Webber",
      description:
